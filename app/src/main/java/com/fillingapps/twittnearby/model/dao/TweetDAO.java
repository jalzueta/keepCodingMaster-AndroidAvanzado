package com.fillingapps.twittnearby.model.dao;
...
import static com.fillingapps.twittnearby.model.db.DBConstants.*;
...
public class TweetDAO implements DAOPersistable<Tweet> {
    ...
    public static ContentValues getContentValues(Tweet data) {
        ...
        contentValues.put(KEY_TWEET_USER_IMAGE_URL, data.getUserImageUrl());
        ...
        contentValues.put(KEY_TWEET_LATITUDE, data.getLatitude());
        contentValues.put(KEY_TWEET_LONGITUDE, data.getLongitude());
